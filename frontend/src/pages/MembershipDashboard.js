...
export const MembershipDashboard = () => {
    ...
    if (!membershipData) {
        return (_jsx(DashboardContainer, { children: _jsx(Section, { children: _jsx(Container, { children: _jsxs(ContentWrapper, { children: [_jsxs(WelcomeSection, { children: [_jsx("h1", { children: "Welcome to TVK Canada" }), _jsx("div", { className: "subtitle", children: "Join our community and connect with fellow Thalapathy fans" })] }), _jsxs(PremiumCard, { children: [_jsx("h2", { style: { textAlign: 'center', marginBottom: theme.spacing.lg }, children: "Join Our Community" }), _jsx("p", { style: { textAlign: 'center', fontSize: theme.typography.fontSize.lg, marginBottom: theme.spacing.xl }, children: "Become part of the TVK Canada family! Get updates on programs, events, and connect with fellow community members across Canada." }), _jsxs(ActionSection, { children: [_jsx(EnhancedButton, { variant: "primary", onClick: () => window.location.href = '/join', children: "Join Free" }), _jsx(EnhancedButton, { variant: "outline", onClick: () => window.location.href = '/programs', children: "View Programs" })] })] })] }) }) }) }));
    }
