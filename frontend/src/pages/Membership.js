...
export const MembershipPage = () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Section, { padding: `${theme.spacing.xxxl} 0`, background: theme.colors.surface, children: _jsx(Container, { children: _jsxs(OfferBanner, { children: [_jsx("h3", { children: "\uD83C\uDF89 Limited Offer: First 200 Members Get 6 Months FREE!" }), _jsx("p", { children: "Join TVK Canada now and receive 6 months of membership absolutely FREE, plus a Special Edition Founding Member Physical Card." })] }) }) }), _jsx(Section, { padding: `${theme.spacing.xxxl} 0`, children: _jsxs(Container, { children: [_jsx("h2", { style: { textAlign: 'center', marginBottom: theme.spacing.xxl }, children: "Membership Plans" }), _jsxs(Grid, { columns: 3, gap: theme.spacing.xl, children: [_jsxs(PricingCard, { featured: selectedPlan === 'monthly', children: [isPlanActivated('monthly') && _jsx(CurrentPlanBadge, { children: "\u2713 Your Current Plan" }), _jsx("h3", { children: "Monthly" }), _jsxs("div", { className: "price", children: ["$10", _jsx("span", { children: "/month" })] }), _jsx(Button, { variant: isPlanActivated('monthly') ? 'secondary' : selectedPlan === 'monthly' ? 'secondary' : 'outline', fullWidth: true, onClick: () => !isPlanActivated('monthly') && setSelectedPlan('monthly'), disabled: isPlanActivated('monthly'), style: {
                                            ...
                                            }, children: isPlanActivated('monthly') ? '✓ Active Plan' : selectedPlan === 'monthly' ? 'Selected' : 'Choose Plan' }), _jsxs("ul", { children: [_jsx("li", { children: "Official TVK Canada membership card" }), _jsx("li", { children: "Access to exclusive events" }), _jsx("li", { children: "Member-only discounts" }), _jsx("li", { children: "Community forum access" }), _jsx("li", { children: "Event early registration" })] })] }), _jsxs(PricingCard, { featured: selectedPlan === 'yearly', children: [isPlanActivated('yearly') && _jsx(CurrentPlanBadge, { children: "\u2713 Your Current Plan" }), _jsx("h3", { children: "Annual - Save $20!" }), _jsxs("div", { className: "price", children: ["$100", _jsx("span", { children: "/year" })] }), _jsx(Button, { variant: isPlanActivated('yearly') ? 'secondary' : selectedPlan === 'yearly' ? 'secondary' : 'outline', fullWidth: true, onClick: () => !isPlanActivated('yearly') && setSelectedPlan('yearly'), disabled: isPlanActivated('yearly'), style: {
                                            ...
                                            }, children: isPlanActivated('yearly') ? '✓ Active Plan' : selectedPlan === 'yearly' ? 'Selected' : 'Choose Plan' }), _jsxs("ul", { children: [_jsx("li", { children: "Official TVK Canada membership card" }), _jsx("li", { children: "Access to all exclusive events" }), _jsx("li", { children: "Premium partner discounts" }), _jsx("li", { children: "VIP community forum access" }), _jsx("li", { children: "Priority event registration" }), _jsx("li", { children: "Annual celebration invitation" })] })] }), _jsxs(PricingCard, { featured: selectedPlan === 'student', children: [isPlanActivated('student') && _jsx(CurrentPlanBadge, { children: "\u2713 Your Current Plan" }), _jsx("h3", { children: "Student" }), _jsxs("div", { className: "price", children: ["$5", _jsx("span", { children: "/month" })] }), _jsx(Button, { variant: isPlanActivated('student') ? 'secondary' : selectedPlan === 'student' ? 'secondary' : 'outline', fullWidth: true, onClick: () => !isPlanActivated('student') && setSelectedPlan('student'), disabled: isPlanActivated('student'), style: {
