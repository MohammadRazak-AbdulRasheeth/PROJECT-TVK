...
export const SEO = ({ title, description, keywords, canonicalUrl, ogTitle, ogDescription, ogImage = '/images/tvk-og-image.jpg', ogType = 'website', twitterTitle, twitterDescription, noIndex = false, structuredData }) => {
